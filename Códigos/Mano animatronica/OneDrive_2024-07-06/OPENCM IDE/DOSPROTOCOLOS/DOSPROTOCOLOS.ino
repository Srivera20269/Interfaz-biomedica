/* Metodo para utilizar los servomotores 
Dynamixel AX-12A y XL320 
...
//  delay(1000);
  ...
  word SyncPage1[6]=
  { 
    XL_320_ID_NUM1,0,  // 3 Dynamixels are move to position 0
    XL_320_ID_NUM2,0, // with velocity 100
    XL_320_ID_NUM3,0}; 
    
  word SyncPage2[6]=
  { 
    XL_320_ID_NUM1,512, // 3 Dynamixels are move to position 512
    XL_320_ID_NUM2,512, // with velocity 500
    XL_320_ID_NUM3,512,};
